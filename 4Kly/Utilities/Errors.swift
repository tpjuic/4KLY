...
enum BinaryError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .binaryNotFound:
            return "yt-dlp not found. 4Kly will attempt to download it automatically."
        ...
        case .permissionDenied:
            return "Permission denied. Please grant 4Kly access to the Application Support directory."
        }
    }
