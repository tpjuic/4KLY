...
actor GitHubAPIClient {
    ...
    func fetchLatestRelease() async throws -> UpdateInfo {
        ...
        request.setValue("4Kly/1.0", forHTTPHeaderField: "User-Agent")
...
actor BinaryUpdater {
    ...
    init(githubAPI: GitHubAPIClient) {
        ...
        // Set binaryPath to ~/Library/Application Support/4Kly/yt-dlp
        let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
        self.binaryPath = appSupport.appendingPathComponent("4Kly").appendingPathComponent("yt-dlp")
    }
